...
var init_CredentialEntity = __esm({
  "node_modules/@azure/msal-common/dist/cache/entities/CredentialEntity.js"() {
    ...
    function() {
      ...
      CredentialEntity2.credentialDomainRegex = "(https?:\\/\\/)?((([\\w-]+\\.)*([\\w-]{1,63})(\\.(\\w{2,63})))|(localhost))(\\:[0-9]{4,5})?(\\/[\\w-]+)?";
...
var BrowserConstants, NativeConstants, NativeExtensionMethod, BrowserCacheLocation, HTTP_REQUEST_TYPE, TemporaryCacheKeys, InMemoryCacheKeys, ApiId, InteractionType, InteractionStatus, DEFAULT_REQUEST, KEY_FORMAT_JWK, WrapperSKU, DB_NAME, DB_VERSION, DB_TABLE_NAME, CacheLookupPolicy;
...
@azure/msal-browser/dist/index.js:
  (*! @azure/msal-browser v2.34.0 2023-03-07 *)
*/
//# sourceMappingURL=chunk-5W42CVRY.js.map
