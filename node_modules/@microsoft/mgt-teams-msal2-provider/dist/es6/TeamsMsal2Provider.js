...
import { LoginType, MICROSOFT_GRAPH_DEFAULT_ENDPOINT, ProviderState, TeamsHelper } from '@microsoft/mgt-element';
...
export class TeamsMsal2Provider extends Msal2Provider {
     ...
     * @memberof TeamsMsal2Provider
     */
    static handleAuth(baseURL = MICROSOFT_GRAPH_DEFAULT_ENDPOINT) {
