            ...
            if (!this.people) {
                ...
                if (provider && provider.state === ProviderState.SignedIn) {
                    ...
                    if (this.groupId) {
                        ...
                        this.userIds
                            ? (this.people = yield getUsersForUserIds(graph, this.userIds, '', '', this._fallbackDetails))
                            : (this.people = yield getUsersForPeopleQueries(graph, this.peopleQueries, this._fallbackDetails));
                    }
