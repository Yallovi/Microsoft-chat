 ...
 * @return {*}  {Promise<Chat>}
 */
export declare function createChat(graph: IGraph, person: string, user: string): Promise<Chat>;
/**
 ...
 */
export declare function sendMessage(graph: IGraph, chatId: string, messageData: {
    body?: {
        content: string;
    };
}): Promise<ChatMessage>;
