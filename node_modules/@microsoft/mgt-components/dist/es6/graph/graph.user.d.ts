 ...
 * @returns {Promise<User[]>}
 */
export declare function getUsersForUserIds(graph: IGraph, userIds: string[], searchInput?: string, userFilters?: string, fallbackDetails?: IDynamicPerson[]): Promise<User[]>;
/**
 ...
 * @returns {Promise<User[]>}
 */
export declare function getUsersForPeopleQueries(graph: IGraph, peopleQueries: string[], fallbackDetails?: IDynamicPerson[]): Promise<User[]>;
/**
