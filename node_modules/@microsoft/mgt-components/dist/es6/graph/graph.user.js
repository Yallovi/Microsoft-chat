 ...
 * @returns {Promise<User[]>}
 */
export function getUsersForUserIds(graph, userIds, searchInput = '', userFilters = '', fallbackDetails) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * @returns {Promise<User[]>}
 */
export function getUsersForPeopleQueries(graph, peopleQueries, fallbackDetails) {
    return __awaiter(this, void 0, void 0, function* () {
